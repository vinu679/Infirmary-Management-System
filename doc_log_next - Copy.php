...
<form class="regform" method="post" action="doc_preview.php">
	...
	<fieldset id="second">
		...
		<tr><td>Visit Count: </td><td><input type="text_field" name="id" placeholder="" type="text" value="<?php echo $count;?>" readonly></td></tr>
		...
		<input id="next_btn1" name="next" type="submit" value="Next">
	</fieldset>
